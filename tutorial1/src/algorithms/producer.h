...
#ifndef   _ALGORITHM_PRODUCER_H_
#define   _ALGORITHM_PRODUCER_H_
...
namespace algorithms
{
  ...
  **/
   ...
   **/
  class producerFactory : public gams::algorithms::AlgorithmFactory
  {
  public:
     /**
     * Creates a producer algorithm.
