...
#ifndef   _ALGORITHM_CONSUMER_H_
#define   _ALGORITHM_CONSUMER_H_
...
namespace algorithms
{
  ...
  **/
   ...
   **/
  class consumerFactory : public gams::algorithms::AlgorithmFactory
  {
  public:
     /**
     * Creates a consumer algorithm.
